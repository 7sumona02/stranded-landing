...
const About = () => {
  return (
    ...
    <div className='bg-white/3 border border-t-gray-700/40 border-b-gray-900/50 border-x-gray-900/50 rounded-[5em] flex items-center justify-center px-40 py-24'>
      <div className='max-w-lg text-4xl font-medium'>
