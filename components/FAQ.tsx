  ...
  return (
    <div className=''>
      <div className='container mx-auto max-w-2xl pb-20 pt-2'>
        <div className='h-fit border border-gray-700/60  rounded-lg p-2 bg-white/3 px-10 py-12'>
          {tabs.map((tab, FAQ) => (
            <motion.div
              key={FAQ}
              className={`overflow-hidden ${
                FAQ !== tabs.length - 1 ? 'border-b border-gray-700/60' : ''
              }`}
            ...
            >
              ...
              <AnimatePresence mode='sync'>
                {activeFAQ === FAQ && (
                  ...
                  >
                    <p
                      className={`dark:text-gray-400 text-gray-700 p-3 xl:text-xl sm:text-sm text-xl pt-0 w-[90%]`}
                    >
                      {tab.description}
                    </p>
                  </motion.div>
